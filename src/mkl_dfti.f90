...
MODULE MKL_DFT_TYPE
  ...
  INTEGER(INT64), PARAMETER :: DFTI_SPKP = SELECTED_REAL_KIND(6,37)
  INTEGER(INT64), PARAMETER :: DFTI_DPKP = SELECTED_REAL_KIND(15,307)
  ...
  ! DFTI_COMMIT_STATUS
  INTEGER(INT64), PARAMETER :: DFTI_COMMITTED = 30
  INTEGER(INT64), PARAMETER :: DFTI_UNCOMMITTED = 31

  ! DFTI_FORWARD_DOMAIN
  INTEGER(INT64), PARAMETER :: DFTI_COMPLEX = 32
  INTEGER(INT64), PARAMETER :: DFTI_REAL = 33
  ! INTEGER(INT64), PARAMETER :: DFTI_CONJUGATE_EVEN = 34 ! NOT IMPLEMENTED

  ! DFTI_PRECISION
  INTEGER(INT64), PARAMETER :: DFTI_SINGLE = 35
  INTEGER(INT64), PARAMETER :: DFTI_DOUBLE = 36
  ...
  ! DFTI_FORWARD_SIGN
  ! INTEGER(INT64), PARAMETER :: DFTI_NEGATIVE = 37 ! NOT IMPLEMENTED
  ! INTEGER(INT64), PARAMETER :: DFTI_POSITIVE = 38 ! NOT IMPLEMENTED

  ! DFTI_COMPLEX_STORAGE and DFTI_CONJUGATE_EVEN_STORAGE
  INTEGER(INT64), PARAMETER :: DFTI_COMPLEX_COMPLEX = 39
  INTEGER(INT64), PARAMETER :: DFTI_COMPLEX_REAL = 40

  ! DFTI_REAL_STORAGE
  INTEGER(INT64), PARAMETER :: DFTI_REAL_COMPLEX = 41
  INTEGER(INT64), PARAMETER :: DFTI_REAL_REAL = 42

  ! DFTI_PLACEMENT
  INTEGER(INT64), PARAMETER :: DFTI_INPLACE = 43 ! Result overwrites input
  INTEGER(INT64), PARAMETER :: DFTI_NOT_INPLACE  = 44 ! Have another place for result

  ! DFTI_INITIALIZATION_EFFORT
  ! INTEGER(INT64), PARAMETER :: DFTI_LOW = 45 ! NOT IMPLEMENTED
  ! INTEGER(INT64), PARAMETER :: DFTI_MEDIUM = 46 ! NOT IMPLEMENTED
  ! INTEGER(INT64), PARAMETER :: DFTI_HIGH = 47 ! NOT IMPLEMENTED

  ! DFTI_ORDERING
  INTEGER(INT64), PARAMETER :: DFTI_ORDERED = 48
  INTEGER(INT64), PARAMETER :: DFTI_BACKWARD_SCRAMBLED = 49
  ! INTEGER(INT64), PARAMETER :: DFTI_FORWARD_SCRAMBLED  = 50 ! NOT IMPLEMENTED

  ! Allow/avoid certain usages
  INTEGER(INT64), PARAMETER :: DFTI_ALLOW = 51 ! Allow transposition or workspace
  INTEGER(INT64), PARAMETER :: DFTI_AVOID = 52 ! Avoid auxiliary storage
  INTEGER(INT64), PARAMETER :: DFTI_NONE = 53

  ! DFTI_PACKED_FORMAT
  ! (for storing congugate-even finite sequence in real array)
  INTEGER(INT64), PARAMETER :: DFTI_CCS_FORMAT = 54  ! Complex conjugate-symmetric
  INTEGER(INT64), PARAMETER :: DFTI_PACK_FORMAT = 55 ! Pack format for real DFT
  INTEGER(INT64), PARAMETER :: DFTI_PERM_FORMAT = 56 ! Perm format for real DFT
  INTEGER(INT64), PARAMETER :: DFTI_CCE_FORMAT = 57  ! Complex conjugate-even

  !======================================================================
  ! Error classes
  !======================================================================
  INTEGER(INT64), PARAMETER :: DFTI_NO_ERROR = 0
  INTEGER(INT64), PARAMETER :: DFTI_MEMORY_ERROR = 1
  INTEGER(INT64), PARAMETER :: DFTI_INVALID_CONFIGURATION = 2
  INTEGER(INT64), PARAMETER :: DFTI_INCONSISTENT_CONFIGURATION = 3
  INTEGER(INT64), PARAMETER :: DFTI_MULTITHREADED_ERROR = 4
  INTEGER(INT64), PARAMETER :: DFTI_BAD_DESCRIPTOR = 5
  INTEGER(INT64), PARAMETER :: DFTI_UNIMPLEMENTED = 6
  INTEGER(INT64), PARAMETER :: DFTI_MKL_INTERNAL_ERROR = 7
  INTEGER(INT64), PARAMETER :: DFTI_NUMBER_OF_THREADS_ERROR = 8
  INTEGER(INT64), PARAMETER :: DFTI_1D_LENGTH_EXCEEDS_INT32 = 9

  ! Maximum length of error string
  INTEGER(INT64), PARAMETER :: DFTI_MAX_MESSAGE_LENGTH = 80

  ! Maximum length of user-settable descriptor name
  INTEGER(INT64), PARAMETER :: DFTI_MAX_NAME_LENGTH = 10

  ! Maximum length of Intel(R) MKL version string
  INTEGER(INT64), PARAMETER :: DFTI_VERSION_LENGTH = 198
...
MODULE MKL_DFTI
  ...
  INTERFACE DftiCreateDescriptor
     ...
     FUNCTION dfti_create_descriptor_1d(desc, precision, domain, dim, length)
       ...
       INTEGER(INT64) dfti_create_descriptor_1d
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       INTEGER(INT64), INTENT(IN) :: precision
       INTEGER(INT64), INTENT(IN) :: domain
       INTEGER(INT64), INTENT(IN) :: dim, length
     ...
     FUNCTION dfti_create_descriptor_highd(desc, precision, domain, dim,length)
       ...
       INTEGER(INT64) dfti_create_descriptor_highd
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       INTEGER(INT64), INTENT(IN) :: precision
       INTEGER(INT64), INTENT(IN) :: domain
       INTEGER(INT64), INTENT(IN) :: dim
       INTEGER(INT64), INTENT(IN), DIMENSION(*) :: length
     ...
     FUNCTION dfti_create_descriptor_s_1d(desc, s, dom, one, dim)
       ...
       INTEGER(INT64) dfti_create_descriptor_s_1d
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), INTENT(IN) :: s
       INTEGER(INT64), INTENT(IN) :: dom
       INTEGER(INT64), INTENT(IN) :: one
       INTEGER(INT64), INTENT(IN) :: dim
     ...
     FUNCTION dfti_create_descriptor_s_md(desc, s, dom, many, dims)
       ...
       INTEGER(INT64) dfti_create_descriptor_s_md
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), INTENT(IN) :: s
       INTEGER(INT64), INTENT(IN) :: dom
       INTEGER(INT64), INTENT(IN) :: many
     ...
     FUNCTION dfti_create_descriptor_d_1d(desc, d, dom, one, dim)
       ...
       INTEGER(INT64) dfti_create_descriptor_d_1d
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_create_descriptor_d_md(desc, d, dom, many, dims)
       ...
       INTEGER(INT64) dfti_create_descriptor_d_md
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_DPKP), INTENT(IN) :: d
       INTEGER(INT64), INTENT(IN) :: dom
       INTEGER(INT64), INTENT(IN) :: many
  ...
  INTERFACE DftiCopyDescriptor
     ...
     FUNCTION dfti_copy_descriptor_external(desc, new_desc)
       ...
       INTEGER(INT64) dfti_copy_descriptor_external
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
  ...
  INTERFACE DftiCommitDescriptor
     ...
     FUNCTION dfti_commit_descriptor_external(desc)
       ...
       INTEGER(INT64) dfti_commit_descriptor_external
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
  ...
  INTERFACE DftiSetValue
     ...
     ! overloading of DftiSetValue for integer(int64) value
     FUNCTION dfti_set_value_intval(desc, OptName, IntVal)
       ...
       INTEGER(INT64) dfti_set_value_intval
       INTEGER(INT64), INTENT(IN) :: OptName
       INTEGER(INT64), INTENT(IN) :: IntVal
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_set_value_sglval(desc, OptName, sglval)
       ...
       INTEGER(INT64) dfti_set_value_sglval
       INTEGER(INT64), INTENT(IN) :: OptName
     ...
     FUNCTION dfti_set_value_dblval(desc, OptName, DblVal)
       ...
       INTEGER(INT64) dfti_set_value_dblval
       INTEGER(INT64), INTENT(IN) :: OptName
       REAL(DFTI_DPKP), INTENT(IN) :: DblVal
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     END FUNCTION dfti_set_value_dblval

     ! overloading of DftiSetValue for integer(int64) vector
     FUNCTION dfti_set_value_intvec(desc, OptName, IntVec)
       ...
       INTEGER(INT64) dfti_set_value_intvec
       INTEGER(INT64), INTENT(IN) :: OptName
       INTEGER(INT64), INTENT(IN), DIMENSION(*) :: IntVec
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_set_value_chars(desc, OptName, Chars)
       ...
       INTEGER(INT64) dfti_set_value_chars
       INTEGER(INT64), INTENT(IN) :: OptName
  ...
  INTERFACE DftiGetValue
     ...
     ! overloading of DftiGetValue for integer(int64) value
     FUNCTION dfti_get_value_intval(desc, OptName, IntVal)
       ...
       INTEGER(INT64) dfti_get_value_intval
       INTEGER(INT64), INTENT(IN) :: OptName
       INTEGER(INT64), INTENT(OUT) :: IntVal
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_get_value_sglval(desc, OptName, sglval)
       ...
       INTEGER(INT64) dfti_get_value_sglval
       INTEGER(INT64), INTENT(IN) :: OptName
     ...
     FUNCTION dfti_get_value_dblval(desc, OptName, DblVal)
       ...
       INTEGER(INT64) dfti_get_value_dblval
       INTEGER(INT64), INTENT(IN) :: OptName
       REAL(DFTI_DPKP), INTENT(OUT) :: DblVal
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     END FUNCTION dfti_get_value_dblval

     ! overloading of DftiGetValue for integer(int64) vector
     FUNCTION dfti_get_value_intvec(desc, OptName, IntVec)
       ...
       INTEGER(INT64) dfti_get_value_intvec
       INTEGER(INT64), INTENT(IN) :: OptName
       INTEGER(INT64), INTENT(OUT), DIMENSION(*) :: IntVec
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_get_value_chars(desc, OptName, Chars)
       ...
       INTEGER(INT64) dfti_get_value_chars
       INTEGER(INT64), INTENT(IN) :: OptName
  ...
  INTERFACE DftiComputeForward
     ...
     FUNCTION dfti_compute_forward_s(desc,sSrcDst)
       ...
       INTEGER(INT64) dfti_compute_forward_s
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_c(desc,cSrcDst)
       ...
       INTEGER(INT64) dfti_compute_forward_c
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_ss(desc,sSrcDstRe,sSrcDstIm)
       ...
       INTEGER(INT64) dfti_compute_forward_ss
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_sc(desc,sSrc,cDst)
       ...
       INTEGER(INT64) dfti_compute_forward_sc
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_cc(desc,cSrc,cDst)
       ...
       INTEGER(INT64) dfti_compute_forward_cc
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_ssss(desc,sSrcRe,sSrcIm,sDstRe,sDstIm)
       ...
       INTEGER(INT64) dfti_compute_forward_ssss
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_d(desc,dSrcDst)
       ...
       INTEGER(INT64) dfti_compute_forward_d
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_z(desc,zSrcDst)
       ...
       INTEGER(INT64) dfti_compute_forward_z
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_dd(desc,dSrcDstRe,dSrcDstIm)
       ...
       INTEGER(INT64) dfti_compute_forward_dd
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_dz(desc,dSrc,zDst)
       ...
       INTEGER(INT64) dfti_compute_forward_dz
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_zz(desc,zSrc,zDst)
       ...
       INTEGER(INT64) dfti_compute_forward_zz
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
     ...
     FUNCTION dfti_compute_forward_dddd(desc,dSrcRe,dSrcIm,dDstRe,dDstIm)
       ...
       INTEGER(INT64) dfti_compute_forward_dddd
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
  ...
  INTERFACE DftiComputeBackward
     ...
     FUNCTION dfti_compute_backward_s(desc,sSrcDst)
       ...
       INTEGER(INT64) dfti_compute_backward_s
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: sSrcDst
     ...
     FUNCTION dfti_compute_backward_c(desc,cSrcDst)
       ...
       INTEGER(INT64) dfti_compute_backward_c
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: cSrcDst
     ...
     FUNCTION dfti_compute_backward_ss(desc,sSrcDstRe,sSrcDstIm)
       ...
       INTEGER(INT64) dfti_compute_backward_ss
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), DIMENSION(*) :: sSrcDstRe
       REAL(DFTI_SPKP), DIMENSION(*) :: sSrcDstIm
     ...
     FUNCTION dfti_compute_backward_cs(desc,cSrc,sDst)
       ...
       INTEGER(INT64) dfti_compute_backward_cs
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: cSrc
     ...
     FUNCTION dfti_compute_backward_cc(desc,cSrc,cDst)
       ...
       INTEGER(INT64) dfti_compute_backward_cc
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: cSrc
       COMPLEX(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: cDst
     ...
     FUNCTION dfti_compute_backward_ssss(desc,sSrcRe,sSrcIm,sDstRe,sDstIm)
       ...
       INTEGER(INT64) dfti_compute_backward_ssss
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: sSrcRe
       REAL(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: sSrcIm
       REAL(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: sDstRe
     ...
     FUNCTION dfti_compute_backward_d(desc,dSrcDst)
       ...
       INTEGER(INT64) dfti_compute_backward_d
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: dSrcDst
     ...
     FUNCTION dfti_compute_backward_z(desc,zSrcDst)
       ...
       INTEGER(INT64) dfti_compute_backward_z
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: zSrcDst
     ...
     FUNCTION dfti_compute_backward_dd(desc,dSrcDstRe,dSrcDstIm)
       ...
       INTEGER(INT64) dfti_compute_backward_dd
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_DPKP), DIMENSION(*) :: dSrcDstRe
       REAL(DFTI_DPKP), DIMENSION(*) :: dSrcDstIm
     ...
     FUNCTION dfti_compute_backward_zd(desc,zSrc,dDst)
       ...
       INTEGER(INT64) dfti_compute_backward_zd
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: zSrc
     ...
     FUNCTION dfti_compute_backward_zz(desc,zSrc,zDst)
       ...
       INTEGER(INT64) dfti_compute_backward_zz
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: zSrc
       COMPLEX(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: zDst
     ...
     FUNCTION dfti_compute_backward_dddd(desc,dSrcRe,dSrcIm,dDstRe,dDstIm)
       ...
       INTEGER(INT64) dfti_compute_backward_dddd
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: dSrcRe
       REAL(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: dSrcIm
       REAL(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: dDstRe
  ...
  INTERFACE DftiFreeDescriptor
     ...
     FUNCTION dfti_free_descriptor_external(desc)
       ...
       INTEGER(INT64) dfti_free_descriptor_external
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
  ...
  INTERFACE DftiErrorClass
     ...
     FUNCTION dfti_error_class_external(Status, ErrorClass)
       ...
       INTEGER(INT64), INTENT(IN) :: ErrorClass
