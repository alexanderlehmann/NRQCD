...
module su3
  ...
  !! 0 & 0 & +1 
  !! \end{pmatrix},&&
  !! T_1=\frac{1}{2}\lambda_1=\frac{1}{2}\cdot\begin{pmatrix}
  !! 0 & +1 & 0 \\
  !! +1 & 0 & 0 \\
  !! 0 & 0 & 0 
  !! \end{pmatrix},&&
  !! T_2=\frac{1}{2}\lambda_2=\frac{1}{2}\cdot\begin{pmatrix}
  !! 0 & -\text{i} & 0 \\
  !! +\text{i} & 0 & 0 \\
  !! 0 & 0 & 0 
  !! \end{pmatrix},
  !! \\
  !! T_3=\frac{1}{2}\lambda_3=\frac{1}{2}\cdot\begin{pmatrix}
  !! +1 & 0 & 0 \\
  !! 0 & -1 & 0 \\
  !! 0 & 0 & 0 
  !! \end{pmatrix},&&
  !! T_4=\frac{1}{2}\lambda_4=\frac{1}{2}\cdot\begin{pmatrix}
  !! 0 & 0 & +1 \\
  !! 0 & 0 & 0 \\
  !! +1 & 0 & 0 
  !! \end{pmatrix},&&
  !! T_5=\frac{1}{2}\lambda_5=\frac{1}{2}\cdot\begin{pmatrix}
  !! 0 & 0 & -\text{i} \\
  !! 0 & 0 & 0 \\
  !! +\text{i} & 0 & 0 
  !! \end{pmatrix},
  !! \\
  !! T_6=\frac{1}{2}\lambda_6=\frac{1}{2}\cdot\begin{pmatrix}
  !! 0 & 0 & 0 \\
  !! 0 & 0 & +1 \\
  !! 0 & +1 & 0 
  !! \end{pmatrix},&&
  !! T_7=\frac{1}{2}\lambda_7=\frac{1}{2}\cdot\begin{pmatrix}
  !! 0 & 0 & 0 \\
  !! 0 & 0 & -\text{i} \\
  !! 0 & +\text{i} & 0 
  !! \end{pmatrix},&&
  !! T_8=\frac{1}{2}\lambda_8=\frac{1}{2}\cdot\frac{1}{\sqrt{3}}\begin{pmatrix}
  !! +1 & 0 & 0 \\
  !! 0 & +1 & 0 \\
  !! 0 & 0 & -2 
  !! \end{pmatrix}
